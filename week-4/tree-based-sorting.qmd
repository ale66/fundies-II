...
Sorting arrays with BubbleSort: easy to visualise+implement but costly

Many comparisons are repeated: waste of time, costs grow with $n^2$
...
- Binary Search Trees: a tree organisation that makes values easy to sort/search
